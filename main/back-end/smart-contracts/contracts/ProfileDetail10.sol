...
contract ProfileDetail10 {
    ...
    constructor(address _ownerAddress) public {
        ...
        createReview(5, "My very second review", "Escanor", "Business", 2);
        createReview(5, "My very third review", "Hackerman", "Customer", 3);
        createReview(5, "My very fourth review", "Astro", "Customer", 4);
