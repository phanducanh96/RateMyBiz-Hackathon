          ...
          <li className={ this.isPathActive('/user-pages') ? 'nav-item active' : 'nav-item' }>
            ...
            <Collapse in={ this.state.userPagesMenuOpen }>
              <ul className="nav flex-column sub-menu">
                ...
                <li className="nav-item"> <Link className={ this.isPathActive('/user-pages/appsignin') ? 'nav-link active' : 'nav-link' } to="/user-pages/appsignin"><Trans>Register</Trans></Link></li>
              </ul>
            </Collapse>
          </li>
